import sys
sys.path.append('/home/ramesh/Desktop/WS/Implementation/batchgenerators')

from time import time
from batchgenerators.augmentations.crop_and_pad_augmentations import crop
from batchgenerators.dataloading import MultiThreadedAugmenter
from brats2017_dataloader_3D import get_list_of_patients, BraTS2017DataLoader3D, \
    get_train_transform
...
if __name__ == "__main__":
    ...
    train, val = get_split_deterministic(patients, fold=0, num_splits=4, random_state=12345)
